<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:63:"D:/phpStudy/WWW/php8/xiaomi2014/mobile/themes/default/goods.dwt";i:1;s:77:"D:/phpStudy/WWW/php8/xiaomi2014/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1411445487;s:8:"maketime";i:1411441887;}<!DOCTYPE html>
...
<title>双口USB充电器_小米手机1_小米手机_ecshop小米2014旗舰版 PHP源码吧http://php8.taobao.com/ - Powered by ECShop触屏版</title>
...
<script type="text/javascript" src="js/common.js"></script><script type="text/javascript" src="js/transport.js"></script><script type="text/javascript" src="js/utils.js"></script><script type="text/javascript" src="themes/default/js/fbi.js"></script>
...
function chgNum(a) {
    ...
    if (a == 1) {
      ...
      <div class="show">
        ...
        <div class="flexslider">
          <ul class="slides">
            ...
            <li ><img src="../images/201310/goods_img/1_P_1381080926345.jpg" /></li>
             
            <li style="display:none"><img src="../images/201310/goods_img/1_P_1381203515547.jpg" /></li>
             
            <li style="display:none"><img src="../images/201310/goods_img/1_P_1381203515847.jpg" /></li>
             
            <li style="display:none"><img src="../images/201310/goods_img/1_P_1381203515167.jpg" /></li>
                      </ul>
        </div>
      </div>
      ...
      <div class="pro-info">
        <p class="pro-name"><strong>双口USB充电器</strong></br>
          适用于小米手机2 / 2S</p>
        <div class="price clearfix">
          <p class="jx-price">售价&nbsp;&nbsp;&nbsp;<strong>￥40</strong></p>
          <p class="market-price"><strong>￥59</strong></p>
        </div>
		        <div class="brand clearfix">
          <p class="name">品牌</p>
          <p class="detial"><a href="brand.php?id=1" >小米</a></p>
        </div>
		
		<div class='goods_number clearfix'>
          <p class="name">人气</p>
          <span id="msg">541 </span>
		</div>
		<style>
        ...
        <form action="javascript:addToCart(1)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          ...
          <p class="name">颜色</p>
          <div class="catt">
						<a class="cattsel" onclick="changeAtt(this,1,1)"
			href="javascript:;" name="1">白色<input style="display:none"
			id="spec_value_1" type="radio" name="spec_1" value="1" 			checked /></a>
						<a  onclick="changeAtt(this,2,1)"
			href="javascript:;" name="2">红色<input style="display:none"
			id="spec_value_2" type="radio" name="spec_1" value="2"  /></a>
						<a  onclick="changeAtt(this,3,1)"
			href="javascript:;" name="3">蓝色<input style="display:none"
			id="spec_value_3" type="radio" name="spec_1" value="3"  /></a>
						<a  onclick="changeAtt(this,4,1)"
			href="javascript:;" name="4">黑色<input style="display:none"
			id="spec_value_4" type="radio" name="spec_1" value="4"  /></a>
						</div>
		</div>
          ...
          <div class='goods_number clearfix'>
            <p class="detial clearfix">购买可使用：<font class="red">0 积分</font></p>
          </div>
      ...
      <div class="pro-detial">
        <div class="judge clearfix"> <a href="goods.php?act=view_comment&id=1"><span class="m-ratescore"><i style="WIDTH: 100%">100%</i></span> <span class="all"><strong>554fcae493e564ee0dc75bdf2ebf94cagoods_comment|a:2:{s:4:"name";s:13:"goods_comment";s:2:"id";s:1:"1";}554fcae493e564ee0dc75bdf2ebf94ca</strong>人评论</span> <span class="nice"><strong>100%</strong>好评</span></a> <span class="arrow"></span> </div>
        <div class="pro-intro clearfix"> <a href="goods.php?act=view_img&id=1"><span>商品详细介绍</span></a> <span class="arrow"></span> </div>
      </div>
...
<div class="recommend">
	...
	<div class="item-container" id="item-container">
		...
		<ul>
			...
			<li>
			<a href="" class="item-pic"><img src="../images/201310/thumb_img/2_thumb_G_1381081006658.jpg" /></a>
            <p class="price">￥28 </p>
			</li>
		
        
			<li>
			<a href="" class="item-pic"><img src="../images/201310/thumb_img/3_thumb_G_1381081063005.jpg" /></a>
            <p class="price">￥99 </p>
			</li>
		
        
			<li>
			<a href="" class="item-pic"><img src="../images/201310/thumb_img/4_thumb_G_1381081094117.jpg" /></a>
            <p class="price">￥98 </p>
			</li>
		
        
			<li>
			<a href="" class="item-pic"><img src="../images/201310/thumb_img/5_thumb_G_1381081130578.jpg" /></a>
            <p class="price">￥39 </p>
			</li>
...
<script language="javascript">
$('#pc_nav').attr('href', './../goods.php?id=1');
</script>
</body>
</html>