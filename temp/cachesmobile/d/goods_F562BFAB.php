<?php exit;?>a:3:{s:8:"template";a:2:{i:0;s:63:"D:/phpStudy/WWW/php8/xiaomi2014/mobile/themes/default/goods.dwt";i:1;s:77:"D:/phpStudy/WWW/php8/xiaomi2014/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1411445110;s:8:"maketime";i:1411441510;}<!DOCTYPE html>
...
<title>魔声Beats Studio HD 2.0耳机 红色_配件_ecshop小米2014旗舰版 PHP源码吧http://php8.taobao.com/ - Powered by ECShop触屏版</title>
...
<div class="header_03">
  ...
  <div style="" class="tit">
    <h3>魔声Beats Studio HD 2.0耳机 红色</h3>
  </div>
  <div class="nav">
    <ul>
...
function chgNum(a) {
    ...
    if (a == 1) {
      ...
      <div class="show">
        ...
        <div class="flexslider">
          <ul class="slides">
            ...
            <li ><img src="./../../images/201405/goods_img/10_P_1399531258646.jpg" /></li>
                      </ul>
        </div>
      </div>
      ...
      <div class="pro-info">
        <p class="pro-name"><strong>魔声Beats Studio HD 2.0耳机 红色</strong></br>
          </p>
        <div class="price clearfix">
          <p class="jx-price">售价&nbsp;&nbsp;&nbsp;<strong>￥3000</strong></p>
          <p class="market-price"><strong>￥3600</strong></p>
        </div>
        ...
        <form action="javascript:addToCart(10)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
          ...
          <div class='goods_number clearfix'>
            <p class="detial clearfix">购买可使用：<font class="red">3000 积分</font></p>
          </div>
      ...
      <div class="pro-detial">
        <div class="judge clearfix"> <a href="goods.php?act=view_comment&id=10"><span class="m-ratescore"><i style="WIDTH: 100%">100%</i></span> <span class="all"><strong>554fcae493e564ee0dc75bdf2ebf94cagoods_comment|a:2:{s:4:"name";s:13:"goods_comment";s:2:"id";s:2:"10";}554fcae493e564ee0dc75bdf2ebf94ca</strong>人评论</span> <span class="nice"><strong>100%</strong>好评</span></a> <span class="arrow"></span> </div>
        <div class="pro-intro clearfix"> <a href="goods.php?act=view_img&id=10"><span>商品详细介绍</span></a> <span class="arrow"></span> </div>
      </div>
...
<script language="javascript">
$('#pc_nav').attr('href', './../goods.php?id=10');
</script>
</body>
</html>